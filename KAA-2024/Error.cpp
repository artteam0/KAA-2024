...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(305, "[ SEMANTIC ] Объявление переменной без ключевого слова ann недопустимо"),
		...
		ERROR_ENTRY(323, "[ SEMANTIC ] Деление на ноль (Ошибка в выражении)"),
		ERROR_ENTRY(324, "[ SEMANTIC ] Имя идентификатора больше 10"),
